...
case $TEST_NUM in
  1)
    ...
    python ../scripts/diffsnx.py   -i ex11/ex1120624.snx            -o solutions/ex11/ex1120624.snx             -p
    python ../scripts/difftrace.py -i ex11/ex11-ALIC201919900.TRACE -o solutions/ex11/ex11-ALIC201919900.TRACE  -p
    ;;
  2)
    ...
    python ../scripts/diffsnx.py   -i ex12/ex1220624.snx            -o solutions/ex12/ex1220624.snx             -p
    python ../scripts/difftrace.py -i ex12/ex12-ALIC201919900.TRACE -o solutions/ex12/ex12-ALIC201919900.TRACE  -p
    ;;
  3)
    ...
    python ../scripts/diffsnx.py   -i ex13/ex1320624.snx            -o solutions/ex13/ex1320624.snx             -p

    for trace in `ls ex13/*.TRACE`; do
    tracebase="$(basename $trace)";
    python ../scripts/difftrace.py -i $trace -o "solutions/ex13/$tracebase" -p;
    done
    ;;
  4)
    ...
    python ../scripts/diffsnx.py   -i ex14/ex1420624.snx            -o solutions/ex14/ex1420624.snx             -p
    python ../scripts/difftrace.py -i ex14/TUG/ex14-ALIC201919900.TRACE -o solutions/ex14/TUG/ex14-ALIC201919900.TRACE -p
    ;;
  5)
  ...
  6)
    ...
    # python ../scripts/diffsnx.py -i ex16/ex1620624.snx -o solutions/ex16/ex1620624.snx #should be removed from yaml
    diff ex16/ex16_201919900.stec solutions/ex16/ex16_201919900.stec
